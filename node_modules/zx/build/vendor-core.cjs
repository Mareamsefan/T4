...
var normalizeCtx = (...ctxs) => assign({
  ...
  ee: new import_node_events.default(),
...
var VoidWritable = class extends import_node_stream2.Transform {
  ...
  try {
    if (c.sync) {
      ...
      c.run(() => {
        ...
        (_b = child.stdout) == null ? void 0 : _b.on("data", (d) => {
...
// node_modules/@webpod/ps/target/esm/index.mjs
var EOL2 = /(\r\n)|(\n\r)|\n|\r/;
var IS_WIN = import_node_process3.default.platform === "win32";
var isBin = (f) => {
  if (f === "") return false;
...
var kill = (pid, opts, next) => {
  ...
  try {
    import_node_process3.default.kill(+pid, signal);
  } catch (e) {
    reject(e);
